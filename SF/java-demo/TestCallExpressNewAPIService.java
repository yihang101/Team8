...
public class TestCallExpressNewAPIService {
		...
		/**丰桥新沙箱测试顾客编码  SJLBNQKKsq
		 校验码  cqC3Ta5X6nSpJkJueExHJF4t0cV0WmvY
		 **/
		private static final String CLIENT_CODE = "SJLBNQKKsq";  //此处替换为您在丰桥平台获取的顾客编码
		private static final String CHECK_WORD = "cqC3Ta5X6nSpJkJueExHJF4t0cV0WmvY";//此处替换为您在丰桥平台获取的校验码
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
       ...
       //   IServiceCodeStandard standardService = ExpressServiceCodeEnum.EXP_RECE_SEARCH_PROMITM;//预计派送时间查询
        ...
        params.put("msgDigest", tools.getMsgDigest(msgData,timeStamp,CHECK_WORD));//数据签名
